// Package db: This package containe the database related code
package db
...
//go:generate go run  go.uber.org/mock/mockgen@v0.6.0 -destination repo/mocks/repo.go -package mocks ./repo UsersRepo

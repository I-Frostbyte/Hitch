// Package repo provides a repository for users, ie a way to store and retrieve users.
package repo
...
import (
	...
	"github.com/I-Frostbyte/Hitch/users/db/sqlc"
...
func NewUsersRepo(db *pgxpool.Pool) *Impl {
	return &Impl{db: db}
}

...
const file_protos_users_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\v.users.UserR\x04user2\xcd\x01\n" +
	"\vUserService\x12A\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x18.users.UpdateUserRequest\x1a\x19.users.UpdateUserResponseB.Z,github.com/I-Frostbyte/Hitch/protobufs/usersb\x06proto3"

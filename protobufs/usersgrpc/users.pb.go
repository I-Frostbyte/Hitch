...
const file_protos_users_proto_rawDesc = "" +
	"\n" +
	"\x12protos/users.proto\x12\x05users\"q\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12!\n" +
	"\fphone_number\x18\x03 \x01(\tR\vphoneNumber\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\"n\n" +
	...
	"\x04user\x18\x01 \x01(\v2\v.users.UserR\x04user2\xd9\x01\n" +
	"\vUserService\x12A\n" +
	"\n" +
	"CreateUser\x12\x18.users.CreateUserRequest\x1a\x19.users.CreateUserResponse\x12D\n" +
	"\vGetUserByID\x12\x19.users.GetUserByIDRequest\x1a\x1a.users.GetUserByIDResponse\x12A\n" +
	"\n" +
	"UpdateUser\x12\x18.users.UpdateUserRequest\x1a\x19.users.UpdateUserResponseB2Z0github.com/I-Frostbyte/Hitch/protobufs/usersgrpcb\x06proto3"
...
var file_protos_users_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_protos_users_proto_depIdxs = []int32{
	...
	3, // 4: users.UserService.GetUserByID:input_type -> users.GetUserByIDRequest
	5, // 5: users.UserService.UpdateUser:input_type -> users.UpdateUserRequest
	2, // 6: users.UserService.CreateUser:output_type -> users.CreateUserResponse
	4, // 7: users.UserService.GetUserByID:output_type -> users.GetUserByIDResponse
	6, // 8: users.UserService.UpdateUser:output_type -> users.UpdateUserResponse
